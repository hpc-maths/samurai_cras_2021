...
x_reference_begin  = np.loadtxt("x_reference_begin.dat")
y_reference_begin  = np.loadtxt("y_reference_begin.dat")
y_exact_begin      = np.loadtxt("y_exact_begin.dat")
x_jump_begin       = np.loadtxt("x_jump_begin.dat")
y_jump_begin       = np.loadtxt("y_jump_begin.dat")
...
y_reference_final  = np.loadtxt("y_reference_final.dat")
y_exact_final      = np.loadtxt("y_exact_final.dat")
y_jump_final       = np.loadtxt("y_jump_final.dat")
